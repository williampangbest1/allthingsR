...
The take-home message here is to understand the general idea behind what a function is doing — and leave the nut and bolts idiosyncrasies to Google or Stackoverflow. We will be introducing the `group_by` function in a bit that makes life easier, but just to finish up with the example:
